// ========================================================
// UPGRADED APP-STYLE MENU NAV ENGINE WITH 3 THEMES (V3.0)
// ========================================================
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    <header class="sticky top-0 z-40 w-full border-b border-[#1A1A24] bg-[#050508]/80 backdrop-blur-md transition-colors duration-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-4">
                ...
                <button id="drawer-menu-open-btn" class="w-9 h-9 flex items-center justify-center rounded-xl bg-[#0B0B0F] border border-[#1A1A24] text-white hover:border-purple-500 transition-all duration-200">
    ...
    <div id="app-drawer" class="fixed top-0 right-0 z-50 h-full w-[280px] sm:w-[325px] bg-[#0B0B0F] border-l border-[#1A1A24] transform translate-x-full transition-transform duration-300 ease-in-out p-6 flex flex-col justify-between">
        <div>
            ...
            <div class="flex items-center justify-between pb-6 border-b border-[#1A1A24]">
                ...
                <button id="drawer-menu-close-btn" class="w-8 h-8 flex items-center justify-center rounded-lg text-[#8E9AA8] hover:text-white hover:bg-[#1A1A24] transition">
            ...
            <nav class="mt-8 space-y-4">
                ...
                <a href="index.html" class="block text-sm font-medium text-neutral-200 hover:text-purple-400 transition">&bull; Business Breakdowns</a>
                <a href="about.html" class="block text-sm font-medium text-neutral-200 hover:text-purple-400 transition">&bull; About Us</a>
                
                <p class="text-[10px] font-mono tracking-widest uppercase text-[#8E9AA8] pt-4">Legal Framework</p>
                <a href="disclaimer.html" class="block text-xs font-medium text-neutral-400 hover:text-pink-400 transition">&bull; Disclaimer Statement</a>
                <a href="privacy.html" class="block text-xs font-medium text-neutral-400 hover:text-pink-400 transition">&bull; Privacy Policy</a>
            </nav>
        </div>
        ...
        <div class="border-t border-[#1A1A24] pt-6">
            ...
            <div class="grid grid-cols-3 gap-2">
                <!-- Theme Buttons -->
                <button data-set-theme="dark" class="text-[11px] font-bold py-2 px-1 rounded-xl border border-[#1A1A24] bg-[#050508] text-white active:border-purple-500 transition">Dark</button>
                ...
                <button data-set-theme="eyecare" class="text-[11px] font-bold py-2 px-1 rounded-xl border border-[#2C241E] bg-[#1C1814] text-[#E6D7C3] transition">Eye Care</button>
            </div>
